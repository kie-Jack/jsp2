...
<ul>
	...
	<li>
		<ul>
			...
			<li>page : Object, 일반 자바객체(요청을 처리하는 웹서블릿 객체가 아닙니다.)</li>
			<li>config : ServletConfig, 웹애플리케이션 정보 저장</li>
			<li>session : HttpSession, 웹서버와 브라우저 사이의 연결정보를 저장하는 객체</li>
...
<%
//	현재 요청을 처리하는 JSP 페이지의 Exception 객체를 pageContext.getException() 리턴받는다.
//	--> Exception 발생 시
//	--> 오류 없으면 Exception 객체는 null입니다.
//	String msg = pageContext.getException().getMessage();
//	out.print(msg);
